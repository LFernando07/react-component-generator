...
export function MainContent({ user, project }: MainContentProps) {
  ...
  // ✅ Asegurar que initialData siempre sea un objeto
  const initialData = project?.data || {};

  // ✅ Asegurar que initialMessages siempre sea un array
  const initialMessages = Array.isArray(project?.messages) ? project.messages : [];
